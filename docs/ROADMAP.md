...
| **P1** | Clash / Mihomo YAML import | Много провайдеров отдают только Clash | **M** | 3x-ui |
| **P1** | QR import (камера / картинка → URL / URI / текст) | Удобный перенос с телефона | **S–M** | 3x-ui |
...
2. **Clash import** (P1, M) — форматы провайдеров  
3. **QR** (P1, S–M) — UX поверх импорта  
